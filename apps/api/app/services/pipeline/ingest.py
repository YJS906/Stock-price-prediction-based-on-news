                    ...
                    with db.begin_nested():
                        ...
                        if relevance.is_stock_relevant:
                            ...
                            for candidate in candidates[:15]:
                                theme_boost = (
                                    0.05 if any(link.theme.slug in theme_scores for link in candidate.stock.themes) else 0.0
                                )
                        ...
                        if article.source_type == SourceType.FOREIGN:
                            db.add(
                                ForeignNewsImpact(
                                    ...
                                    or "해외 이벤트가 국내 공급망과 관련 테마에 미칠 영향을 요약한 문장입니다.",
                        ...
                        # Flush all linked inserts inside the savepoint so duplicates do not poison the outer transaction.
                        db.flush()
